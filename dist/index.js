...
var utils = __nccwpck_require__(4407);
var util = __nccwpck_require__(3837);
var debug = __nccwpck_require__(8237)('websocket:server');
var EventEmitter = (__nccwpck_require__(2361).EventEmitter);
...
exports.BufferingLogger = function createBufferingLogger(identifier, uniqueID) {
    var logFunction = __nccwpck_require__(8237)(identifier);
...
/* harmony import */ var _supabase_supabase_js__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(1206);
/* harmony import */ var _supabase_supabase_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__nccwpck_require__.n(_supabase_supabase_js__WEBPACK_IMPORTED_MODULE_2__);
...
const file = process.cwd() + "/" + (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)("ORIGIN_PATH")

const supabase = (0,_supabase_supabase_js__WEBPACK_IMPORTED_MODULE_2__.createClient)(
...
async function run() {
  ...
  const { error } = await supabase.storage
    ...
    .upload((0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)("TARGET_PATH"), (0,fs__WEBPACK_IMPORTED_MODULE_1__.readFileSync)(file))
